...
urlpatterns = [
    ...
    re_path(r'^ajax$', views.AjaxHandler, name='ajax_handler'),
    re_path(r'^search$', views.SearchHandler, name='search_handler'),
    re_path(r'^bestAnswer$', views.BestAnswerHandler, name='best_answer_handler'),
    path('upvote', views.DoUpvote, name='upvote'),
